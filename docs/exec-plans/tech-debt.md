...
|----|------|----------|----------|----------|
| TD-010 | contract-governance | 端云契约尚无自动化 schema 漂移检查 | 2026-04-11 | 已新增 `central-agent/tests/test_contract_governance.py`，用真实 `edge-agent` report mapper 输出校验 `EdgeReportIn` 契约与 forbidden 字段红线 |
