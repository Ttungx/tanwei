...
export type AppSection = 'overview' | 'edge' | 'central'
...
const ITEMS: Array<{ id: AppSection; label: string; note: string }> = [
  ...
  { id: 'edge', label: 'Edge 控制台', note: '上传 pcap、跟踪 edge-agent 检测任务。' },
  { id: 'central', label: 'Central 智能体', note: '查看 edge1/edge2 情报并手动触发综合研判。' },
]
